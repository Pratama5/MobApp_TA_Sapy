...
class HiddenUpload extends StatefulWidget {
  const HiddenUpload({Key? key}) : super(key: key);

  @override
  State<HiddenUpload> createState() => _HiddenUploadState();
}

class _HiddenUploadState extends State<HiddenUpload> {
  ...
  Future<void> _uploadFile(String fileType) async {
    ...
    try {
      ...
      final tableName =
          fileType == 'audio' ? 'audio_watermarked' : 'image_extracted';
